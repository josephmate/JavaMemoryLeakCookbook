...
jmap -F -dump:live,format=b,file=$workingDir\heap.dump.windows.forced.hprof $p.Id


Stop-Process -id $p.Id


java -cp 'target/lib/*;target\use.heap.service-1.0-SNAPSHOT.jar' CountHprof -hprof heap.dump.windows.forced.hprof
